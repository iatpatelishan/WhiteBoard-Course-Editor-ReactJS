...
export const FORM_CHANGE_CSS_STYLE = 'FORM_CHANGE_CSS_STYLE'
export const FORM_CHANGE_OPTIONS = 'FORM_CHANGE_OPTIONS'
export const FORM_CHANGE_ANSWER = 'FORM_CHANGE_ANSWER'
export const FORM_CHANGE_ANSWER_LIST = 'FORM_CHANGE_ANSWER_LIST'
export const FORM_CHANGE_ANSWER_LIST_SELECT = 'FORM_CHANGE_ANSWER_LIST_SELECT'