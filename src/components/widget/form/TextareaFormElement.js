...
const TextareaFormElement = ({topicId, widget, element, deleteElement, changeLabel, changeLabelDirection, changeCSS}) => {
    let labelElem;
    let labelDirection;
    let cssElem;
    return (
                ...
                <div className="col-sm-10">
                    ...
                    <div>
                        ...
                        <pre className="wbdv-cursor" contentEditable="true" onKeyDown={(e) => preventEditing(e)}>
                            ...
                            color : #5f5f5f; <br/>
                            border-style: dotted; <br/>options
                            {"}"}
                            <br/>
                            <br/>
                            ...
                            <br/>
                            <br/>
                            #{"T" + topicId + "Elem" + element.orderno + "Textarea"} {"{"} <br/>
...
const TextareaFormElementContainer = connect(stateToPropsMapper, dispathToPropsMapper)(TextareaFormElement);

export default TextareaFormElementContainer;